      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className={`p-8 glass-panel rounded-3xl border ${feature.borderColor} bg-linear-to-br ${feature.bgClass} shadow-lg shadow-gray-100/50 hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300 flex items-start sm:items-center gap-6 group cursor-default`}
            >
