...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`mt-2 w-full max-w-7xl mx-auto rounded-full shadow-md border-white/10 top-0 z-50 flex items-center justify-between px-6 py-3 md:px-12 backdrop-blur-md bg-white/50 transition-transform duration-300 ${
